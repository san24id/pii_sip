...
class Login_model extends CI_Model{
    ...
    function insert_regist($regist){
        ...
        $sql = $this->db->query("INSERT INTO `t_user`(`nomor_user`, `nama_user`, `instansi`, `jabatan`, `email`, `telepon`, `username`, `password`, `log_create`, `log_update`) VALUES ( '$nomor_user', '$nama_user','$instansi','$jabatan','$email','$telepon','$username',md5('$password'),NOW(), NOW())");
