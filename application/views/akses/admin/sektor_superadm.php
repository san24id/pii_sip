            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>                    
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#ubah<?php echo $row->id_sektor; ?>">Ubah</button>
                      <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?php echo $row->id_sektor; ?>">Hapus</button>
            ...
            <form method="post" action="superadm/addsektor">
             <table class="table">
                 <tr>
                  <th>Nama Sektor</th>
                  <td>:</td>
                  <td><input type="text" name="nama_sektor" class="form-control"></td>
...
<!-- Modal -->
<div class="modal fade" id="ubah<?php echo $row->id_sektor; ?>" role="dialog" aria-hidden="true"  tabindex="-1"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
  ...
  <div class="modal fade" id="hapus<?php echo $row->id_sektor; ?>" tabindex="-1" role="dialog" aria-hidden="true">
