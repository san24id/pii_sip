...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SC</b>AN</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SCANNING</b>SYSTEM</span>
    </a>
            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>Cikarang</td>
                  <td> 30 T</td>
                  <td><a href="Dashboard/FormVerifikasiProyek"><button class="btn btn-primary">view</button></a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>User1PJPK</td>
