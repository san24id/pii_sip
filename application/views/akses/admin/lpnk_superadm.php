    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="acc" method="post" action="superadm/addlpnk">
             <table class="table">
                  <tr>
                  <th>Nama LPNK</th>
                  <td>:</td>
...
<div class="modal fade" id="ubah<?php echo $row->id_lpnk; ?>" role="dialog" aria-hidden="true"  tabindex="-1"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="ganti" method="post" action="superadm/updatelpnk">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <form id="deleted" method="post" action="superadm/deletelpnk">
          <input type="hidden" name="id_lpnk" value="<?php echo $row->id_lpnk; ?>">
