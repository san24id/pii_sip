                                      ...
                                      <?php 
                                        if($Y[13] == 'checked'){
                                            ...
                                            <div style="display: none;">
                                              ...
                                              <a href="<?php echo 'upload/'.$upload[13]; ?>"><button type="button" class="btn btn-default btn-sm">Download FIle No.9</button></a>
                                       <?php }}?>
                          </td>
          ...
          <div class="row">
              <div class="col-xs-12">
                ...
                <div class="box">
                  <!-- /.box-header -->
                  <div class="box-body">
                    TOTAL SKOR : <b><?php echo $rowp->total_skor; ?></b>
                    <br>
                     <?php if($rowp->komen1 != '' || $rowp->komen1 != NULL){ ?>
                        ...
                        NOTE &nbsp;: &nbsp;
                          ...
                          <textarea readonly class="form-control" cols="3" name="respon1" placeholder="Note" required></textarea>
                        </form>
                      <?php } ?> 
                      <br>
                      <?php if($rowp->status == 6){ ?>
                        ...
                        Last Admin User &nbsp;: &nbsp;<input type="text" value="" readonly><br><br>
                     ...
                     Last Admin User &nbsp;: &nbsp;<input type="text" value="<?php echo $res->user1 ?>" readonly><br><br>
                          <button type="submit" class="btn btn-primary" name="save" value="draft">Save</button>&nbsp;&nbsp;&nbsp;&nbsp;
                          <button type="submit" class="btn btn-success" name="submit" value="submit">Submit</button>
                        </form>
                ...
                <div class="box-footer">
                 ...
                 <a href="dashboard/submitprofilstatus/<?php echo $ss; ?>/?ss=<?php echo $ss; ?>"><button type="button" class="btn btn-warning btn-sm">Kembali</button></a>
