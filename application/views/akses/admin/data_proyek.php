...
<head>
  ...
  <style type="text/css">
    .modal-dialog {
       min-width: calc(346vh - 1050px)
    }
    .modal-body {

   max-width: calc(730vh - 1050px);
    overflow-x: auto;
    }
    ...
    <section class="content">
      <!-- Info boxes -->
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
                          <a href=""><button type="button" class="btn btn-block btn-primary" style="width: 100px">Export</button></a>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>PP0001</td>
                  <td>Hermanto</td>
                  <td>Kementrian Pekerjaan Umum dan Perumahan Rakyat</td>
                  <td>infrastruktur Jalan</td>
                  <td>Tol Layang Cikarang Bandung</td>
                  <td>Cikarang</td>
                  <td> 30 T</td>
                  <td>65%</td>
                  <td>Short List</td>
                  <td><a href="Dashboard/FormVerifikasiProyek"><button class="btn btn-success">Verify</button></a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>PP0002</td>
