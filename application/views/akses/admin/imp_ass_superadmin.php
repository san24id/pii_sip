    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="acc" method="post" action="superadm/addassesment">
             <table class="table">
                <tr>
                  <th>Nomor Urut</th>
                  <td>:</td>
...
<div class="modal fade" id="ubah<?php echo $row->id_ass; ?>" role="dialog" aria-hidden="true"  tabindex="-1"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="ganti" method="post" action="superadm/updateassesment">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <p align="justify">Apa kamu yakin akan menghapus Assessment :  <?=$row->nomor_urut?></p>
       <p> Kriteria : <?=$row->creteria?> </p>
      </div>
      <div class="modal-footer">
      <form id="deleted" method="post" action="superadm/deleteassesment">
          <input type="hidden" name="id_ass" value="<?php echo $row->id_ass; ?>">
