            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <td>                    
                      <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#ubah<?php echo $row->id_provinsi; ?>">Ubah</button>
                      <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?php echo $row->id_provinsi; ?>">Hapus</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="acc" method="post" action="superadm/addprov">
             <table class="table">
                  <tr>
                  <th>Nama Provinsi</th>
                  <td>:</td>
...
<div class="modal fade" id="ubah<?php echo $row->id_provinsi; ?>" role="dialog" aria-hidden="true"  tabindex="-1"  data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h5>
            <form id="ganti" method="post" action="superadm/updateprov">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <form id="deleted" method="post" action="superadm/deleteprov">
          <input type="hidden" name="id_provinsi" value="<?php echo $row->id_provinsi; ?>">
