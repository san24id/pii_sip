            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="box-footer">
                   <button type="button" data-toggle="modal" data-target="#modalNext" class="btn btn-primary btn-sm">Rekomendasi</button>
                  <a href="Home"><button type="button" class="btn btn-warning btn-sm">Kembali</button></a>
                </div>
              </div>
              <!-- /.box-body -->
            </div>
