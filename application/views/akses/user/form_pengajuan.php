                      ...
                      <?php if($id_ass[0] != '' || $id_ass[0] != NULL){ ?>
                        <tr>
                          ...
                          <td><?php echo $pertanyaan[0]; ?>&nbsp;<?php if($penjelasan[0] == NULL || $penjelasan[0] == ''){  }else{ ?> <i class="glyphicon glyphicon-info-sign" style="color: blue; cursor:pointer;" data-toggle="modal" data-target="#bnomor0"></i><?php } ?>
                            <br>
                                       <input type="radio" name="p0"  value="Y" class="pi0">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p0"  value="N" class="pi0">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y0">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n0">
                                       ...
                                       <?php foreach ($noass0 as $row) {
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a0 ac0'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                        ...
                        <tr>
                          ...
                          <td><?php echo $pertanyaan[1]; ?>&nbsp;<?php if($penjelasan[1] == NULL || $penjelasan[1] == ''){  }else{ ?> <i class="glyphicon glyphicon-info-sign" style="color: blue; cursor:pointer;" data-toggle="modal" data-target="#bnomor1"></i><?php } ?>
                                <br>
                                       <input type="radio" name="p1"  value="Y" class="pi1">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p1"  value="N" class="pi1">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y1">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n1">
                                       ...
                                       <?php foreach ($noass1 as $row) {
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a1 ac1'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                        ...
                        <tr>
                          ...
                          <br>
                                       <input type="radio" name="p2"  value="Y" class="pi2">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p2"  value="N" class="pi2">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y2">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n2">
                                       ...
                                       <div class="dp2" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a2 ac2'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                                              echo "<input name='box5[]' type='hidden' value='".$row->b."' />";
                                              echo "<input name='box6[]' type='hidden' id='test".$key."' value='nonchecked' class='b2' />";
                                              echo "<input name='box7[]' type='hidden' value='".$row->urut."' />";
                                          }else if($row->b == 'text'){
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                       ...
                       <tr>
                          ...
                          <td><?php echo $pertanyaan[3]; ?>&nbsp;<?php if($penjelasan[3] == NULL || $penjelasan[3] == ''){  }else{ ?> <i class="glyphicon glyphicon-info-sign" style="color: blue; cursor:pointer;" data-toggle="modal" data-target="#bnomor3"></i><?php } ?>
                            <br>
                                       <input type="radio" name="p3"  value="Y" class="pi3">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p3"  value="N" class="pi3">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y3">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n3">
                                       ...
                                       <?php foreach ($noass3 as $row) {
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a3 ac3'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                        ...
                        <tr>
                          ...
                          <td><?php echo $pertanyaan[4]; ?>&nbsp;<?php if($penjelasan[4] == NULL || $penjelasan[4] == ''){  }else{ ?> <i class="glyphicon glyphicon-info-sign" style="color: blue; cursor:pointer;" data-toggle="modal" data-target="#bnomor4"></i><?php } ?>
                                <br>
                                       <input type="radio" name="p4"  value="Y" class="pi4">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p4"  value="N" class="pi4">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y4">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n4">
                                       ...
                                       <?php foreach ($noass4 as $row) {
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a4 ac4'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                        ...
                        <tr>
                          ...
                          <br>
                                       <input type="radio" name="p5"  value="Y" class="pi5">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p5"  value="N" class="pi5">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y5">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n5">
                                       ...
                                       <div class="dp5" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a5 ac5'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p6"  value="Y" class="pi6">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p6"  value="N" class="pi6">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y6">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n6">
                                       ...
                                       <div class="dp6" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a6 ac6'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p7"  value="Y" class="pi7">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p7"  value="N" class="pi7">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y7">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n7">
                                       ...
                                       <div class="dp7" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a7 ac7'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p8"  value="Y" class="pi8">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p8"  value="N" class="pi8">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y8">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n8">
                                       ...
                                       <div class="dp8" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a8 ac8'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p9"  value="Y" class="pi9">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p9"  value="N" class="pi9">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y9">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n9">
                                       ...
                                       <div class="dp9" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a9 ac9'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p10"  value="Y" class="pi10">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p10"  value="N" class="pi10">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y10">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n10">
                                       ...
                                       <div class="dp10" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a10 ac10'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p11"  value="Y" class="pi11">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p11"  value="N" class="pi11">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y11">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n11">
                                       ...
                                       <div class="dp11" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a11 ac11'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p12"  value="Y" class="pi12">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p12"  value="N" class="pi12">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y12">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n12">
                                       ...
                                       <div class="dp12" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a12 ac12'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p13"  value="Y" class="pi13">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p13"  value="N" class="pi13">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y13">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n13">
                                       ...
                                       <div class="dp13" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a13 ac13'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p14"  value="Y" class="pi14">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p14"  value="N" class="pi14">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y14">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n14">
                                       ...
                                       <div class="dp14" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a14 ac14'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
                       ...
                       <tr>
                          ...
                          <br>
                                       <input type="radio" name="p15"  value="Y" class="pi15">&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;
                                       <input type="radio" name="p15"  value="N" class="pi15">&nbsp;&nbsp;Tidak
                                       <input type="hidden" name="Y[]" value="nonchecked" class="y15">
                                       <input type="hidden" name="N[]" value="nonchecked" class="n15">
                                       ...
                                       <div class="dp15" style="display: none;">
                                           ...
                                           if($row->b == 'not'){
                                              ...
                                              echo "<input type='".$row->b."' value='".$row->a."' ".$row->c." class='a15 ac15'>&nbsp;".$row->a."<br>";
                                              echo "<input name='box1[]' type='hidden' value='".$row->id."' />";
                                              echo "<input name='box2[]' type='hidden' value='".$row->idass."' />";
                                              echo "<input name='box3[]' type='hidden' value='".$row->nomor_urut."' />";
                                              echo "<input name='box4[]' type='hidden' value='".$row->a."' />";
...
<div class="modal fade" id="bnomor15" tabindex="-1" role="dialog" aria-labelledby="bnomor1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">

      <div class="modal-body">
        <h5><p align="justify"><?php echo $penjelasan[15]; ?></p><h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
